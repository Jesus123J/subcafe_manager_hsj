...
public class ViewMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        // Botón para revertir pagos - diseño moderno
        jLabelRevertirPago = new javax.swing.JLabel();
        jLabelRevertirPago.setFont(new java.awt.Font("Segoe UI", 1, 11));
        jLabelRevertirPago.setForeground(new java.awt.Color(255, 255, 255));
        jLabelRevertirPago.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabelRevertirPago.setText("REVERTIR PAGO");
        jLabelRevertirPago.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jLabelRevertirPago.setOpaque(true);
        jLabelRevertirPago.setBackground(new java.awt.Color(192, 57, 43));
        jLabelRevertirPago.setBorder(javax.swing.BorderFactory.createCompoundBorder(
        ...
        // Botón para reorganizar pagos huérfanos - diseño moderno
        jLabelReorganizarPagos = new javax.swing.JLabel();
        jLabelReorganizarPagos.setFont(new java.awt.Font("Segoe UI", 1, 11));
        jLabelReorganizarPagos.setForeground(new java.awt.Color(255, 255, 255));
        jLabelReorganizarPagos.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabelReorganizarPagos.setText("REORGANIZAR PAGOS");
        jLabelReorganizarPagos.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jLabelReorganizarPagos.setOpaque(true);
        jLabelReorganizarPagos.setBackground(new java.awt.Color(142, 68, 173)); // Púrpura
        jLabelReorganizarPagos.setBorder(javax.swing.BorderFactory.createCompoundBorder(
            javax.swing.BorderFactory.createLineBorder(new java.awt.Color(155, 89, 182), 2),
            javax.swing.BorderFactory.createEmptyBorder(5, 10, 5, 10)
        ));

        // Botón para editar pagos mal distribuidos - diseño moderno
        jLabelEditarPago = new javax.swing.JLabel();
        jLabelEditarPago.setFont(new java.awt.Font("Segoe UI", 1, 11));
        jLabelEditarPago.setForeground(new java.awt.Color(255, 255, 255));
        jLabelEditarPago.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabelEditarPago.setText("EDITAR PAGO");
        jLabelEditarPago.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jLabelEditarPago.setOpaque(true);
        jLabelEditarPago.setBackground(new java.awt.Color(41, 128, 185)); // Azul
        jLabelEditarPago.setBorder(javax.swing.BorderFactory.createCompoundBorder(
